...
<!-- Main content -->
        ...
        <div class="card-body">
      <?php  echo form_open('Subject/insert', array('method'=>'post', 'name'=>'subject_from')) ;?>
          <div class="form-group">
          <?php echo form_label('Subject Name');?>
          <?php echo form_input(array('name'=>'name', 'class'=>'form-control', 'value'=>'','type'=>'text', 'id'=>'name', 'placeholder'=>"Enter Subject Name"));?>
          </div>
          <div class=" alert-danger"><?=form_error('name'); ?></div>
          
          <div class="form-group">
          <?php echo form_label('Subject Code');?>
          <?php echo form_input(array('name'=>'subject_code', 'class'=>'form-control', 'value'=>'','type'=>'text', 'id'=>'name', 'placeholder'=>"Enter  Subject Code"));?>
          </div>
          ...
          <?php echo form_input(array('name'=>'marks_value', 'class'=>'form-control', 'value'=>'','type'=>'text', 'id'=>'marks_value', 'placeholder'=>"Enter  Marks"));?>
          </div>
