...
<!-- Main content -->
        ...
        <div class="card-body">
        <?=form_open('section/update/'.$getValue->id, array('name'=>'section', 'method'=>'post'))?>
        ...
        <div class="alert-danger"><?=form_error('name')?></div>
            ...
            <?php echo form_input(array('name'=>'description', 'class'=>'form-control', 'value'=>"$getValue->description", 'type'=>'text', 'id'=>'description', 'placeholder'=>"Enter Your Class Description"));?>
